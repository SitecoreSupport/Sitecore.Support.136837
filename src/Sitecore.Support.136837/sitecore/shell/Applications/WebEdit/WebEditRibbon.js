...
function modalDialogLazyLoading() {
  ...
  top.initModalDialog = function (callbackFunc) {
	var jqueryModalDialogsFrame;
   if (top != null)
   {
	jqueryModalDialogsFrame = top.document.getElementById("jqueryModalDialogsFrame");
   }
   else
   {
	  jqueryModalDialogsFrame = window.document.getElementById("jqueryModalDialogsFrame");  
   }
...
if (top != null)
{
	...
	window.scIsDialogsInitialized = false;
}
